...
#Auntentica 
gs4_auth(email = 'mavalentim.b@gmail.com')
...
ui <- fluidPage(
  tabsetPanel(
    ...
    tabPanel("Como virar um tutor",
             ...
             h3("Como criar sua conta no Koalendar"),
             ...
             img(src = 'tutorial_img1.jpg'),
             h4("Vamos clicar em 'Get Started' como circulado abaixo"),
             img(src = 'tutorial_img2.jpg'),
             ...
             img(src ='tutorial_img8.jpg'),
             img(scr = 'tutorial_img9.jpg'),
             img(src= 'tutorial_img10.jpg'),
             h4('Uma vez configurada as características da sua Booking Page, você vai receber
                ...
                formulário que você preenche para se cadastrar para esse site. Ele vai
